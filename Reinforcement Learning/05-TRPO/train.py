...
for episode in range(episodes):
    ...
    returns_to_go = compute_rewards_to_go(rewards, gamma=gamma) # We can instead model this as: r + gamma*value_metwork(next_state), where r is current reward
...
torch.save(policy_network.state_dict(), "cartpole_policy_gradients_policy_net.pth")
torch.save(value_network.state_dict(), "cartpole_policy_gradients_value_net.pth")
